...
namespace Glimpse.StructureMap
{
    public class GlimpseStructureMapTabData
    {
        ...
        public List<object[]> Root = new List<object[]> {new object[] {"Section", "Details"}};
        ...
        public List<object[]> ConfigurationSources = new List<object[]> { new object[] { "Registry", "Details" } };
        //public List<object[]> ConfigurationSources = new List<object[]> { new object[] { "#", "Registry" } };
        public List<object[]> General = new List<object[]> { new object[] { "Property", "Value"}};
